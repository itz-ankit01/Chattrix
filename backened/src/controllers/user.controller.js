...
export async function acceptFriendRequest(req, res) {
    try {
        ...
        // $addToSet: adds element to the array if they do not already exists
        ...
        console.error("Error in accepting friend request Controller", error.message);
        res.status(500).json({message: "Internal Server Error"});
    }
}
...
export async function getOutgoingFriendReqs(req, res) {
    try {
        ...
        console.error("Error in getOngoingFriendrequests Controller", error.message);
        res.status(500).json({message: "Internal Server Error"});
    }
}